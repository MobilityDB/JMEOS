...
- [x] `extern Span *floatspan_in(const char *str);` Class not defined in PyMEOS
...
- [x] `extern Span *float_to_floaspan(double d);` Class not defined in PyMEOS
- [x] `extern Span *int_to_intspan(int i);` Class not defined in PyMEOS
...
- [x] `extern double floatspan_lower(const Span *s);` Class not defined in PyMEOS
- [x] `extern double floatspan_upper(const Span *s);` Class not defined in PyMEOS
- [x] `extern int intspan_lower(const Span *s);` Class not defined in PyMEOS
- [x] `extern int intspan_upper(const Span *s);` Class not defined in PyMEOS
- [x] `extern Interval *period_duration(const Span *s);` Implemented in python
...
- [x] `extern uint64 periodset_hash_extended(const PeriodSet *ps, uint64 seed);`
- [x] `extern int periodset_mem_size(const PeriodSet *ps);`
...
- [x] `extern Interval *periodset_timespan(const PeriodSet *ps);` Implemented in python
...
- [x] `extern uint64 span_hash_extended(const Span *s, uint64 seed);`
- [x] `extern bool span_lower_inc(const Span *s);` Access information directly
- [x] `extern bool span_upper_inc(const Span *s);` Access information directly
...
- [x] `extern uint64 timestampset_hash_extended(const TimestampSet *ss, uint64 seed);`
- [x] `extern int timestampset_mem_size(const TimestampSet *ss);`
...
- [x] `extern bool overleft_geo_tpoint(const GSERIALIZED *geo, const Temporal *tpoint);` `right_tpoint_geo` used instead
...
- [x] `extern Temporal *teq_geo_tpoint(const GSERIALIZED *geo, const Temporal *tpoint);` `teq_tpoint_geo` used instead
- [x] `extern Temporal *teq_int_tint(int i, const Temporal *temp);` `teq_tint_int` used instead
- [x] `extern Temporal *teq_point_tgeogpoint(const GSERIALIZED *gs, const Temporal *temp);` `teq_tgeogpoint_point` used instead
- [x] `extern Temporal *teq_point_tgeompoint(const GSERIALIZED *gs, const Temporal *temp);` `teq_tgeompoint_point` used instead
...
- [x] `extern Temporal *teq_text_ttext(const text *txt, const Temporal *temp);` `teq_ttext_text` used instead
...
- [x] `extern Temporal *teq_tpoint_geo(const Temporal *tpoint, const GSERIALIZED *geo);` `teq_tgeogpoint_point` and `teq_tgeompoint_point` used instead
- [x] `extern Temporal *teq_ttext_text(const Temporal *temp, const text *txt);`
- [x] `extern Temporal *tge_float_tfloat(double d, const Temporal *temp);` `tlt_tfloat_float` used instead
- [x] `extern Temporal *tge_int_tint(int i, const Temporal *temp);` `tlt_tint_int` used instead
- [x] `extern Temporal *tge_temporal_temporal(const Temporal *temp1, const Temporal *temp2);`
- [x] `extern Temporal *tge_text_ttext(const text *txt, const Temporal *temp);` `tlt_ttext_text` used instead
...
- [x] `extern Temporal *tgt_float_tfloat(double d, const Temporal *temp);` `tle_tfloat_float` used instead
- [x] `extern Temporal *tgt_int_tint(int i, const Temporal *temp);` `tle_tint_int` used instead
- [x] `extern Temporal *tgt_temporal_temporal(const Temporal *temp1, const Temporal *temp2);`
- [x] `extern Temporal *tgt_text_ttext(const text *txt, const Temporal *temp);` `tle_ttext_text` used instead
...
- [x] `extern Temporal *tle_float_tfloat(double d, const Temporal *temp);` `tgt_tfloat_float` used instead
- [x] `extern Temporal *tle_int_tint(int i, const Temporal *temp);` `tgt_tint_int` used instead
- [x] `extern Temporal *tle_temporal_temporal(const Temporal *temp1, const Temporal *temp2);`
- [x] `extern Temporal *tle_text_ttext(const text *txt, const Temporal *temp);` `tgt_ttext_text` used instead
...
- [x] `extern Temporal *tlt_float_tfloat(double d, const Temporal *temp);` `tge_tfloat_float` used instead
- [x] `extern Temporal *tlt_int_tint(int i, const Temporal *temp);` `tge_tint_int` used instead
- [x] `extern Temporal *tlt_temporal_temporal(const Temporal *temp1, const Temporal *temp2);`
- [x] `extern Temporal *tlt_text_ttext(const text *txt, const Temporal *temp);` `tge_ttext_text` used instead
...
- [x] `extern Temporal *tne_bool_tbool(bool b, const Temporal *temp);` `tne_tbool_bool` used instead
- [x] `extern Temporal *tne_float_tfloat(double d, const Temporal *temp);` `tne_tfloat_float` used instead
- [x] `extern Temporal *tne_geo_tpoint(const GSERIALIZED *geo, const Temporal *tpoint);` `tne_tpoint_geo` used instead
- [x] `extern Temporal *tne_int_tint(int i, const Temporal *temp);` `tne_tint_int` used instead
- [x] `extern Temporal *tne_point_tgeogpoint(const GSERIALIZED *gs, const Temporal *temp);` `tne_tgeogpoint_point` used instead
- [x] `extern Temporal *tne_point_tgeompoint(const GSERIALIZED *gs, const Temporal *temp);` `tne_tgeompoint_point` used instead
...
- [x] `extern Temporal *tne_text_ttext(const text *txt, const Temporal *temp);` `tne_ttext_text` used instead
...
- [x] `extern Temporal *tne_tpoint_geo(const Temporal *tpoint, const GSERIALIZED *geo);` `tne_tgeogpoint_point` and `tne_tgeompoint_point` used instead
...
- [x] `extern bool bearing_point_point(const GSERIALIZED *geo1, const GSERIALIZED *geo2, double *result);` Class not defined in PyMEOS 
...
- [x] `extern void skiplist_free(SkipList *list);` Not necessary in PyMEOS
...
- [x] `extern int int_bucket(int value, int size, int origin);`
- [x] `extern double float_bucket(double value, double size, double origin);`
- [x] `extern TimestampTz timestamptz_bucket(TimestampTz timestamp, const Interval *duration, TimestampTz origin);`

- [x] `extern Span *intspan_bucket_list(const Span *bounds, int size, int origin, int *newcount);`
- [x] `extern Span *floatspan_bucket_list(const Span *bounds, double size, double origin, int *newcount);`
- [x] `extern Span *period_bucket_list(const Span *bounds, const Interval *duration, TimestampTz origin, int *newcount);`

- [x] `extern TBOX *tbox_tile_list(const TBOX *bounds, double xsize, const Interval *duration, double xorigin, TimestampTz torigin, int *rows, int *columns);`
...
- [x] `extern STBOX *stbox_tile_list(STBOX *bounds, double size, const Interval *duration, GSERIALIZED *sorigin, TimestampTz torigin, int **cellcount);`
...
- [x] `extern Temporal *geo_to_tpoint(const GSERIALIZED *geo);`
...
- [x] `extern bool tpoint_to_geo_measure(const Temporal *tpoint, const Temporal *measure, bool segmentize, GSERIALIZED **result);`
