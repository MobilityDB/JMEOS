...
public class tstzset extends Set<LocalDateTime> implements Time, TimeCollection {
	...
	public tstzset(Pointer _inner)  {
		super(_inner);
		this._inner = _inner;
		//String str = GeneratedFunctions.tstzset_out(this._inner);
	}
...
//	}
	...
	public List<LocalDateTime> elements() throws Exception {
		Pointer dp= GeneratedFunctions.tstzset_values(this._inner, Memory.allocate(Runtime.getSystemRuntime(), 4));
