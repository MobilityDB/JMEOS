...
public class FunctionsBuilder {
	...
	private static HashMap<String, String> typesBuild() {
		...
		typeChange.put("TimestampTz", "ZonedDateTime"); //TODO mettre ça dans un autre dict, faire la modif pour function mais pas dans l'interface, faire seulement la modife des types Java
