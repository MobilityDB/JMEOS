...
public class functions {
	public static interface MeosLibraryPart0 {

		String gitLibraryPath= "/home/runner/work/JMEOS/JMEOS/src/lib";

		String libraryName= "meos";

		MeosLibraryPart0 INSTANCE = JarLibraryLoader.create(MeosLibraryPart0.class, libraryName).getLibraryInstance();

		MeosLibraryPart0 meos = MeosLibraryPart0.INSTANCE;
	...
	public static interface MeosLibraryPart1 {

		String gitLibraryPath= "/home/runner/work/JMEOS/JMEOS/src/lib";

		String libraryName= "meos";

		MeosLibraryPart1 INSTANCE = JarLibraryLoader.create(MeosLibraryPart1.class, libraryName).getLibraryInstance();

		MeosLibraryPart1 meos = MeosLibraryPart1.INSTANCE;
	...
	public static interface MeosLibraryPart2 {

		String gitLibraryPath= "/home/runner/work/JMEOS/JMEOS/src/lib";

		String libraryName= "meos";

		MeosLibraryPart2 INSTANCE = JarLibraryLoader.create(MeosLibraryPart2.class, libraryName).getLibraryInstance();

		MeosLibraryPart2 meos = MeosLibraryPart2.INSTANCE;
	...
	public static interface MeosLibraryPart3 {

		String gitLibraryPath= "/home/runner/work/JMEOS/JMEOS/src/lib";

		String libraryName= "meos";

		MeosLibraryPart3 INSTANCE = JarLibraryLoader.create(MeosLibraryPart3.class, libraryName).getLibraryInstance();

		MeosLibraryPart3 meos = MeosLibraryPart3.INSTANCE;
	...
	public static int geo_get_srid(Pointer g) {
		return MeosLibraryPart1.meos.geo_get_srid(g);
	}
	
	@SuppressWarnings("unused")
	public static void meos_error(int errlevel, int errcode, String format, Pointer args) {
		MeosLibraryPart1.meos.meos_error(errlevel, errcode, format, args);
	}
	
	@SuppressWarnings("unused")
	public static int meos_errno() {
		return MeosLibraryPart1.meos.meos_errno();
	}
	
	@SuppressWarnings("unused")
	public static int meos_errno_set(int err) {
		return MeosLibraryPart1.meos.meos_errno_set(err);
	}
	
	@SuppressWarnings("unused")
	public static int meos_errno_restore(int err) {
		return MeosLibraryPart1.meos.meos_errno_restore(err);
	}
	
	@SuppressWarnings("unused")
	public static int meos_errno_reset() {
		return MeosLibraryPart1.meos.meos_errno_reset();
	}
	
	@SuppressWarnings("unused")
	public static void meos_initialize_timezone(String name) {
		MeosLibraryPart1.meos.meos_initialize_timezone(name);
	}
	
	@SuppressWarnings("unused")
	public static void meos_initialize_error_handler(error_handler_fn err_handler) {
		MeosLibraryPart1.meos.meos_initialize_error_handler(err_handler);
	}

	public static void meos_initialize_noexit_error_handler() {
		MeosLibraryPart1.meos.meos_initialize_noexit_error_handler();
	}

	@SuppressWarnings("unused")
	public static void meos_finalize_timezone() {
		MeosLibraryPart1.meos.meos_finalize_timezone();
	}
	
	@SuppressWarnings("unused")
	public static boolean meos_set_datestyle(String newval, Pointer extra) {
		return MeosLibraryPart1.meos.meos_set_datestyle(newval, extra);
	}
	
	@SuppressWarnings("unused")
	public static boolean meos_set_intervalstyle(String newval, int extra) {
		return MeosLibraryPart1.meos.meos_set_intervalstyle(newval, extra);
	}
	...
	public static void meos_initialize(String tz_str, error_handler_fn err_handler) {
		MeosLibraryPart1.meos.meos_initialize(tz_str, err_handler);
	}

	@SuppressWarnings("unused")
	public static void meos_initialize() {
		MeosLibraryPart1.meos.meos_initialize();
	}

	@SuppressWarnings("unused")
	public static void meos_set_spatial_ref_sys_csv(String path) {
		MeosLibraryPart1.meos.meos_set_spatial_ref_sys_csv(path);
	}

	@SuppressWarnings("unused")
	public static void meos_finalize() {
		MeosLibraryPart1.meos.meos_finalize();
	}
	
	@SuppressWarnings("unused")
	public static int add_date_int(int d, int days) {
		return MeosLibraryPart0.meos.add_date_int(d, days);
	}
	
	@SuppressWarnings("unused")
	public static Pointer add_interval_interval(Pointer interv1, Pointer interv2) {
		return MeosLibraryPart0.meos.add_interval_interval(interv1, interv2);
	}
	
	@SuppressWarnings("unused")
	public static OffsetDateTime add_timestamptz_interval(OffsetDateTime t, Pointer interv) {
		var t_new = t.toEpochSecond();
		var result = MeosLibraryPart0.meos.add_timestamptz_interval(t_new, interv);
	...
	public static boolean bool_in(String str) {
		return MeosLibraryPart0.meos.bool_in(str);
	}
	
	@SuppressWarnings("unused")
	public static String bool_out(boolean b) {
		return MeosLibraryPart0.meos.bool_out(b);
	}
	
	@SuppressWarnings("unused")
	public static Pointer cstring2text(String str) {
		return MeosLibraryPart0.meos.cstring2text(str);
	}
	
	@SuppressWarnings("unused")
	public static OffsetDateTime date_to_timestamptz(int d) {
		var result = MeosLibraryPart0.meos.date_to_timestamptz(d);
		Instant instant = Instant.ofEpochSecond(result);
		return OffsetDateTime.ofInstant(instant, ZoneOffset.UTC);
	}
	...
	public static Pointer minus_date_date(int d1, int d2) {
		return MeosLibraryPart1.meos.minus_date_date(d1, d2);
	}
	
	@SuppressWarnings("unused")
	public static int minus_date_int(int d, int days) {
		return MeosLibraryPart1.meos.minus_date_int(d, days);
	}
	
	@SuppressWarnings("unused")
	public static OffsetDateTime minus_timestamptz_interval(OffsetDateTime t, Pointer interv) {
		var t_new = t.toEpochSecond();
		var result = MeosLibraryPart1.meos.minus_timestamptz_interval(t_new, interv);
		Instant instant = Instant.ofEpochSecond(result);
		return OffsetDateTime.ofInstant(instant, ZoneOffset.UTC);
	}
	...
	public static Pointer minus_timestamptz_timestamptz(OffsetDateTime t1, OffsetDateTime t2) {
		...
		return MeosLibraryPart1.meos.minus_timestamptz_timestamptz(t1_new, t2_new);
	}
	
	@SuppressWarnings("unused")
	public static Pointer mult_interval_double(Pointer interv, double factor) {
		return MeosLibraryPart1.meos.mult_interval_double(interv, factor);
	}
	
	@SuppressWarnings("unused")
	public static int pg_date_in(String str) {
		return MeosLibraryPart2.meos.pg_date_in(str);
	}
	
	@SuppressWarnings("unused")
	public static String pg_date_out(int d) {
		return MeosLibraryPart2.meos.pg_date_out(d);
	}
	
	@SuppressWarnings("unused")
	public static int pg_interval_cmp(Pointer interv1, Pointer interv2) {
		return MeosLibraryPart2.meos.pg_interval_cmp(interv1, interv2);
	}
	
	@SuppressWarnings("unused")
	public static Pointer pg_interval_in(String str, int typmod) {
		return MeosLibraryPart2.meos.pg_interval_in(str, typmod);
	}
	
	@SuppressWarnings("unused")
	public static Pointer pg_interval_make(int years, int months, int weeks, int days, int hours, int mins, double secs) {
		return MeosLibraryPart2.meos.pg_interval_make(years, months, weeks, days, hours, mins, secs);
	}
	
	@SuppressWarnings("unused")
	public static String pg_interval_out(Pointer interv) {
		return MeosLibraryPart2.meos.pg_interval_out(interv);
	}
	
	@SuppressWarnings("unused")
	public static long pg_time_in(String str, int typmod) {
		return MeosLibraryPart2.meos.pg_time_in(str, typmod);
	}
	
	@SuppressWarnings("unused")
	public static String pg_time_out(long t) {
		return MeosLibraryPart2.meos.pg_time_out(t);
	}
	
	@SuppressWarnings("unused")
	public static LocalDateTime pg_timestamp_in(String str, int typmod) {
		var result = MeosLibraryPart2.meos.pg_timestamp_in(str, typmod);
	...
	public static String pg_timestamp_out(LocalDateTime t) {
		...
		return MeosLibraryPart2.meos.pg_timestamp_out(t_new);
	}
	
	@SuppressWarnings("unused")
	public static OffsetDateTime pg_timestamptz_in(String str, int typmod) {
		var result = MeosLibraryPart2.meos.pg_timestamptz_in(str, typmod);
		Instant instant = Instant.ofEpochSecond(result);
		return OffsetDateTime.ofInstant(instant, ZoneOffset.UTC);
	}
	...
	public static Pointer set_from_hexwkb(String hexwkb) {
		return MeosLibraryPart2.meos.set_from_hexwkb(hexwkb);
	}
	
	@SuppressWarnings("unused")
	public static Pointer set_from_wkb(Pointer wkb, long size) {
		return MeosLibraryPart2.meos.set_from_wkb(wkb, size);
	}
	...
	public static Pointer span_from_hexwkb(String hexwkb) {
		return MeosLibraryPart2.meos.span_from_hexwkb(hexwkb);
	}
	
	@SuppressWarnings("unused")
	public static Pointer span_from_wkb(Pointer wkb, long size) {
		return MeosLibraryPart2.meos.span_from_wkb(wkb, size);
	}
	...
	public static Pointer tstzspan_make(OffsetDateTime lower, OffsetDateTime upper, boolean lower_inc, boolean upper_inc) {
		...
		return MeosLibraryPart3.meos.tstzspan_make(lower_new, upper_new, lower_inc, upper_inc);
	}
	
	@SuppressWarnings("unused")
	public static Pointer bigint_to_set(long i) {
		return MeosLibraryPart0.meos.bigint_to_set(i);
	}
	
	@SuppressWarnings("unused")
	public static Pointer bigint_to_span(int i) {
		return MeosLibraryPart0.meos.bigint_to_span(i);
	}
	
	@SuppressWarnings("unused")
	public static Pointer bigint_to_spanset(int i) {
		return MeosLibraryPart0.meos.bigint_to_spanset(i);
	}
	
	@SuppressWarnings("unused")
	public static Pointer date_to_set(int d) {
		return MeosLibraryPart0.meos.date_to_set(d);
	}
	
	@SuppressWarnings("unused")
	public static Pointer date_to_span(int d) {
		return MeosLibraryPart0.meos.date_to_span(d);
	}
	
	@SuppressWarnings("unused")
	public static Pointer date_to_spanset(int d) {
		return MeosLibraryPart0.meos.date_to_spanset(d);
	}
	
	@SuppressWarnings("unused")
	public static Pointer dateset_to_tstzset(Pointer s) {
		return MeosLibraryPart0.meos.dateset_to_tstzset(s);
	}
	
	@SuppressWarnings("unused")
	public static Pointer datespan_to_tstzspan(Pointer s) {
		return MeosLibraryPart0.meos.datespan_to_tstzspan(s);
	}
	
	@SuppressWarnings("unused")
	public static Pointer datespanset_to_tstzspanset(Pointer ss) {
		return MeosLibraryPart0.meos.datespanset_to_tstzspanset(ss);
	}
	
	@SuppressWarnings("unused")
	public static Pointer float_to_set(double d) {
		return MeosLibraryPart1.meos.float_to_set(d);
	}
	
	@SuppressWarnings("unused")
	public static Pointer float_to_span(double d) {
		return MeosLibraryPart1.meos.float_to_span(d);
	}
	
	@SuppressWarnings("unused")
	public static Pointer float_to_spanset(double d) {
		return MeosLibraryPart1.meos.float_to_spanset(d);
	}
	
	@SuppressWarnings("unused")
	public static Pointer floatset_to_intset(Pointer s) {
		return MeosLibraryPart1.meos.floatset_to_intset(s);
	}
	
	@SuppressWarnings("unused")
	public static Pointer floatspan_to_intspan(Pointer s) {
		return MeosLibraryPart1.meos.floatspan_to_intspan(s);
	}
	
	@SuppressWarnings("unused")
	public static Pointer floatspanset_to_intspanset(Pointer ss) {
		return MeosLibraryPart1.meos.floatspanset_to_intspanset(ss);
	}
	
	@SuppressWarnings("unused")
	public static Pointer geo_to_set(Pointer gs) {
		return MeosLibraryPart1.meos.geo_to_set(gs);
	}
	
	@SuppressWarnings("unused")
	public static Pointer int_to_set(int i) {
		return MeosLibraryPart1.meos.int_to_set(i);
	}
	
	@SuppressWarnings("unused")
	public static Pointer int_to_span(int i) {
		return MeosLibraryPart1.meos.int_to_span(i);
	}
	
	@SuppressWarnings("unused")
	public static Pointer int_to_spanset(int i) {
		return MeosLibraryPart1.meos.int_to_spanset(i);
	}
	
	@SuppressWarnings("unused")
	public static Pointer intset_to_floatset(Pointer s) {
		return MeosLibraryPart1.meos.intset_to_floatset(s);
	}
	
	@SuppressWarnings("unused")
	public static Pointer intspan_to_floatspan(Pointer s) {
		return MeosLibraryPart1.meos.intspan_to_floatspan(s);
	}
	
	@SuppressWarnings("unused")
	public static Pointer intspanset_to_floatspanset(Pointer ss) {
		return MeosLibraryPart1.meos.intspanset_to_floatspanset(ss);
	}
	
	@SuppressWarnings("unused")
	public static Pointer set_to_spanset(Pointer s) {
		return MeosLibraryPart2.meos.set_to_spanset(s);
	}
	
	@SuppressWarnings("unused")
	public static Pointer span_to_spanset(Pointer s) {
		return MeosLibraryPart2.meos.span_to_spanset(s);
	}
	
	@SuppressWarnings("unused")
	public static Pointer text_to_set(Pointer txt) {
		return MeosLibraryPart3.meos.text_to_set(txt);
	}
	
	@SuppressWarnings("unused")
	public static Pointer timestamptz_to_set(OffsetDateTime t) {
		var t_new = t.toEpochSecond();
		return MeosLibraryPart3.meos.timestamptz_to_set(t_new);
	}
	
	@SuppressWarnings("unused")
	public static Pointer timestamptz_to_span(OffsetDateTime t) {
		var t_new = t.toEpochSecond();
		return MeosLibraryPart3.meos.timestamptz_to_span(t_new);
	}
	...
	public static Pointer tstzset_to_dateset(Pointer s) {
		return MeosLibraryPart3.meos.tstzset_to_dateset(s);
	}
	
	@SuppressWarnings("unused")
	public static Pointer tstzspan_to_datespan(Pointer s) {
		return MeosLibraryPart3.meos.tstzspan_to_datespan(s);
	}
	
	@SuppressWarnings("unused")
	public static Pointer tstzspanset_to_datespanset(Pointer ss) {
		return MeosLibraryPart3.meos.tstzspanset_to_datespanset(ss);
	}
	
	@SuppressWarnings("unused")
	public static long bigintset_end_value(Pointer s) {
		return MeosLibraryPart0.meos.bigintset_end_value(s);
	}
	
	@SuppressWarnings("unused")
	public static long bigintset_start_value(Pointer s) {
		return MeosLibraryPart0.meos.bigintset_start_value(s);
	}
	...
	public static Pointer bigintset_value_n(Pointer s, int n) {
		...
		out = MeosLibraryPart0.meos.bigintset_value_n(s, n, result);
		return out ? result : null ;
	}
	
	@SuppressWarnings("unused")
	public static Pointer bigintset_values(Pointer s) {
		return MeosLibraryPart0.meos.bigintset_values(s);
	}
	
	@SuppressWarnings("unused")
	public static long bigintspan_lower(Pointer s) {
		return MeosLibraryPart0.meos.bigintspan_lower(s);
	}
	
	@SuppressWarnings("unused")
	public static long bigintspan_upper(Pointer s) {
		return MeosLibraryPart0.meos.bigintspan_upper(s);
	}
	
	@SuppressWarnings("unused")
	public static long bigintspan_width(Pointer s) {
		return MeosLibraryPart0.meos.bigintspan_width(s);
	}
	
	@SuppressWarnings("unused")
	public static long bigintspanset_lower(Pointer ss) {
		return MeosLibraryPart0.meos.bigintspanset_lower(ss);
	}
	
	@SuppressWarnings("unused")
	public static long bigintspanset_upper(Pointer ss) {
		return MeosLibraryPart0.meos.bigintspanset_upper(ss);
	}
	
	@SuppressWarnings("unused")
	public static long bigintspanset_width(Pointer ss, boolean boundspan) {
		return MeosLibraryPart0.meos.bigintspanset_width(ss, boundspan);
	}
	
	@SuppressWarnings("unused")
	public static int dateset_end_value(Pointer s) {
		return MeosLibraryPart0.meos.dateset_end_value(s);
	}
	
	@SuppressWarnings("unused")
	public static int dateset_start_value(Pointer s) {
		return MeosLibraryPart0.meos.dateset_start_value(s);
	}
	...
	public static Pointer dateset_value_n(Pointer s, int n) {
		...
		Runtime runtime = Runtime.getSystemRuntime();
		Pointer result = Memory.allocateDirect(runtime, Long.BYTES);
		out = MeosLibraryPart0.meos.dateset_value_n(s, n, result);
		return out ? result : null ;
	}
	
	@SuppressWarnings("unused")
	public static Pointer dateset_values(Pointer s) {
		return MeosLibraryPart0.meos.dateset_values(s);
	}
	
	@SuppressWarnings("unused")
	public static Pointer datespan_duration(Pointer s) {
		return MeosLibraryPart0.meos.datespan_duration(s);
	}
	
	@SuppressWarnings("unused")
	public static int datespan_lower(Pointer s) {
		return MeosLibraryPart0.meos.datespan_lower(s);
	}
	
	@SuppressWarnings("unused")
	public static int datespan_upper(Pointer s) {
		return MeosLibraryPart0.meos.datespan_upper(s);
	}
	...
	public static Pointer datespanset_date_n(Pointer ss, int n) {
		...
		Runtime runtime = Runtime.getSystemRuntime();
		Pointer result = Memory.allocateDirect(runtime, Long.BYTES);
		out = MeosLibraryPart0.meos.datespanset_date_n(ss, n, result);
		return out ? result : null ;
	}
	
	@SuppressWarnings("unused")
	public static Pointer datespanset_dates(Pointer ss) {
		return MeosLibraryPart0.meos.datespanset_dates(ss);
	}
	
	@SuppressWarnings("unused")
	public static Pointer datespanset_duration(Pointer ss, boolean boundspan) {
		return MeosLibraryPart0.meos.datespanset_duration(ss, boundspan);
	}
	
	@SuppressWarnings("unused")
	public static int datespanset_end_date(Pointer ss) {
		return MeosLibraryPart0.meos.datespanset_end_date(ss);
	}
	
	@SuppressWarnings("unused")
	public static int datespanset_num_dates(Pointer ss) {
		return MeosLibraryPart0.meos.datespanset_num_dates(ss);
	}
	
	@SuppressWarnings("unused")
	public static int datespanset_start_date(Pointer ss) {
		return MeosLibraryPart0.meos.datespanset_start_date(ss);
	}
	
	@SuppressWarnings("unused")
	public static double floatset_end_value(Pointer s) {
		return MeosLibraryPart1.meos.floatset_end_value(s);
	}
	
	@SuppressWarnings("unused")
	public static double floatset_start_value(Pointer s) {
		return MeosLibraryPart1.meos.floatset_start_value(s);
	}
	...
	public static Pointer floatset_value_n(Pointer s, int n) {
		...
		Runtime runtime = Runtime.getSystemRuntime();
		Pointer result = Memory.allocateDirect(runtime, Long.BYTES);
		out = MeosLibraryPart1.meos.floatset_value_n(s, n, result);
		return out ? result : null ;
	}
	
	@SuppressWarnings("unused")
	public static Pointer floatset_values(Pointer s) {
		return MeosLibraryPart1.meos.floatset_values(s);
	}
	
	@SuppressWarnings("unused")
	public static double floatspan_lower(Pointer s) {
		return MeosLibraryPart1.meos.floatspan_lower(s);
	}
	...
	public static double floatspan_width(Pointer s) {
		return MeosLibraryPart1.meos.floatspan_width(s);
	}
	
	@SuppressWarnings("unused")
	public static double floatspanset_lower(Pointer ss) {
		return MeosLibraryPart1.meos.floatspanset_lower(ss);
	}
	
	@SuppressWarnings("unused")
	public static double floatspanset_upper(Pointer ss) {
		return MeosLibraryPart1.meos.floatspanset_upper(ss);
	}
	
	@SuppressWarnings("unused")
	public static double floatspanset_width(Pointer ss, boolean boundspan) {
		return MeosLibraryPart1.meos.floatspanset_width(ss, boundspan);
	}
	
	@SuppressWarnings("unused")
	public static Pointer geoset_end_value(Pointer s) {
		return MeosLibraryPart1.meos.geoset_end_value(s);
	}
	
	@SuppressWarnings("unused")
	public static int geoset_srid(Pointer s) {
		return MeosLibraryPart1.meos.geoset_srid(s);
	}
	
	@SuppressWarnings("unused")
	public static Pointer geoset_start_value(Pointer s) {
		return MeosLibraryPart1.meos.geoset_start_value(s);
	}
	...
	public static Pointer geoset_value_n(Pointer s, int n) {
		...
		Runtime runtime = Runtime.getSystemRuntime();
		Pointer result = Memory.allocateDirect(runtime, Long.BYTES);
		out = MeosLibraryPart1.meos.geoset_value_n(s, n, result);
	...
	public static Pointer geoset_values(Pointer s) {
		return MeosLibraryPart1.meos.geoset_values(s);
	}
	
	@SuppressWarnings("unused")
	public static int intset_end_value(Pointer s) {
		return MeosLibraryPart1.meos.intset_end_value(s);
	}
	
	@SuppressWarnings("unused")
	public static int intset_start_value(Pointer s) {
		return MeosLibraryPart1.meos.intset_start_value(s);
	}
	...
	public static Pointer intset_value_n(Pointer s, int n) {
		...
		Runtime runtime = Runtime.getSystemRuntime();
		Pointer result = Memory.allocateDirect(runtime, Long.BYTES);
		out = MeosLibraryPart1.meos.intset_value_n(s, n, result);
		return out ? result : null ;
	}
	
	@SuppressWarnings("unused")
	public static Pointer intset_values(Pointer s) {
		return MeosLibraryPart1.meos.intset_values(s);
	}
	
	@SuppressWarnings("unused")
	public static int intspan_lower(Pointer s) {
		return MeosLibraryPart1.meos.intspan_lower(s);
	}
	
	@SuppressWarnings("unused")
	public static int intspan_upper(Pointer s) {
		return MeosLibraryPart1.meos.intspan_upper(s);
	}
	
	@SuppressWarnings("unused")
	public static int intspan_width(Pointer s) {
		return MeosLibraryPart1.meos.intspan_width(s);
	}
	
	@SuppressWarnings("unused")
	public static int intspanset_lower(Pointer ss) {
		return MeosLibraryPart1.meos.intspanset_lower(ss);
	}
	
	@SuppressWarnings("unused")
	public static int intspanset_upper(Pointer ss) {
		return MeosLibraryPart1.meos.intspanset_upper(ss);
	}
	
	@SuppressWarnings("unused")
	public static int intspanset_width(Pointer ss, boolean boundspan) {
		return MeosLibraryPart1.meos.intspanset_width(ss, boundspan);
	}
	
	@SuppressWarnings("unused")
	public static int set_hash(Pointer s) {
		return MeosLibraryPart2.meos.set_hash(s);
	}
	
	@SuppressWarnings("unused")
	public static long set_hash_extended(Pointer s, long seed) {
		return MeosLibraryPart2.meos.set_hash_extended(s, seed);
	}
	
	@SuppressWarnings("unused")
	public static int set_num_values(Pointer s) {
		return MeosLibraryPart2.meos.set_num_values(s);
	}
	
	@SuppressWarnings("unused")
	public static Pointer set_to_span(Pointer s) {
		return MeosLibraryPart2.meos.set_to_span(s);
	}
	
	@SuppressWarnings("unused")
	public static int span_hash(Pointer s) {
		return MeosLibraryPart2.meos.span_hash(s);
	}
	
	@SuppressWarnings("unused")
	public static long span_hash_extended(Pointer s, long seed) {
		return MeosLibraryPart2.meos.span_hash_extended(s, seed);
	}
	
	@SuppressWarnings("unused")
	public static boolean span_lower_inc(Pointer s) {
		return MeosLibraryPart2.meos.span_lower_inc(s);
	}
	...
	public static Pointer spanset_end_span(Pointer ss) {
		return MeosLibraryPart2.meos.spanset_end_span(ss);
	}
	
	@SuppressWarnings("unused")
	public static int spanset_hash(Pointer ss) {
		return MeosLibraryPart2.meos.spanset_hash(ss);
	}
	
	@SuppressWarnings("unused")
	public static long spanset_hash_extended(Pointer ss, long seed) {
		return MeosLibraryPart2.meos.spanset_hash_extended(ss, seed);
	}
	
	@SuppressWarnings("unused")
	public static boolean spanset_lower_inc(Pointer ss) {
		return MeosLibraryPart2.meos.spanset_lower_inc(ss);
	}
	
	@SuppressWarnings("unused")
	public static int spanset_num_spans(Pointer ss) {
		return MeosLibraryPart2.meos.spanset_num_spans(ss);
	}
	
	@SuppressWarnings("unused")
	public static Pointer spanset_span(Pointer ss) {
		return MeosLibraryPart2.meos.spanset_span(ss);
	}
	
	@SuppressWarnings("unused")
	public static Pointer spanset_span_n(Pointer ss, int i) {
		return MeosLibraryPart2.meos.spanset_span_n(ss, i);
	}
	
	@SuppressWarnings("unused")
	public static Pointer spanset_spans(Pointer ss) {
		return MeosLibraryPart2.meos.spanset_spans(ss);
	}
	
	@SuppressWarnings("unused")
	public static Pointer spanset_start_span(Pointer ss) {
		return MeosLibraryPart2.meos.spanset_start_span(ss);
	}
	
	@SuppressWarnings("unused")
	public static boolean spanset_upper_inc(Pointer ss) {
		return MeosLibraryPart2.meos.spanset_upper_inc(ss);
	}
	
	@SuppressWarnings("unused")
	public static Pointer textset_end_value(Pointer s) {
		return MeosLibraryPart3.meos.textset_end_value(s);
	}
	
	@SuppressWarnings("unused")
	public static Pointer textset_start_value(Pointer s) {
		return MeosLibraryPart3.meos.textset_start_value(s);
	}
	...
	public static Pointer textset_value_n(Pointer s, int n) {
		...
		Runtime runtime = Runtime.getSystemRuntime();
		Pointer result = Memory.allocateDirect(runtime, Long.BYTES);
		out = MeosLibraryPart3.meos.textset_value_n(s, n, result);
		Pointer new_result = result.getPointer(0);
		return out ? new_result : null ;
	}
	...
	public static Pointer textset_values(Pointer s) {
		return MeosLibraryPart3.meos.textset_values(s);
	}
	
	@SuppressWarnings("unused")
	public static OffsetDateTime tstzset_end_value(Pointer s) {
		var result = MeosLibraryPart3.meos.tstzset_end_value(s);
		Instant instant = Instant.ofEpochSecond(result);
		return OffsetDateTime.ofInstant(instant, ZoneOffset.UTC);
	}
	...
	public static OffsetDateTime tstzset_start_value(Pointer s) {
		var result = MeosLibraryPart3.meos.tstzset_start_value(s);
		Instant instant = Instant.ofEpochSecond(result);
		return OffsetDateTime.ofInstant(instant, ZoneOffset.UTC);
	}
	...
	public static Pointer tstzset_value_n(Pointer s, int n) {
		...
		Runtime runtime = Runtime.getSystemRuntime();
		Pointer result = Memory.allocateDirect(runtime, Long.BYTES);
		out = MeosLibraryPart3.meos.tstzset_value_n(s, n, result);
		return out ? result : null ;
	}
	
	@SuppressWarnings("unused")
	public static Pointer tstzset_values(Pointer s) {
		return MeosLibraryPart3.meos.tstzset_values(s);
	}
	
	@SuppressWarnings("unused")
	public static Pointer tstzspan_duration(Pointer s) {
		return MeosLibraryPart3.meos.tstzspan_duration(s);
	}
	
	@SuppressWarnings("unused")
	public static OffsetDateTime tstzspan_lower(Pointer s) {
		var result = MeosLibraryPart3.meos.tstzspan_lower(s);
		Instant instant = Instant.ofEpochSecond(result);
		return OffsetDateTime.ofInstant(instant, ZoneOffset.UTC);
	}
	...
	public static OffsetDateTime tstzspan_upper(Pointer s) {
		var result = MeosLibraryPart3.meos.tstzspan_upper(s);
		Instant instant = Instant.ofEpochSecond(result);
		return OffsetDateTime.ofInstant(instant, ZoneOffset.UTC);
	}
	...
	public static Pointer tstzspanset_duration(Pointer ss, boolean boundspan) {
		return MeosLibraryPart3.meos.tstzspanset_duration(ss, boundspan);
	}
	
	@SuppressWarnings("unused")
	public static OffsetDateTime tstzspanset_end_timestamptz(Pointer ss) {
		var result = MeosLibraryPart3.meos.tstzspanset_end_timestamptz(ss);
		Instant instant = Instant.ofEpochSecond(result);
		return OffsetDateTime.ofInstant(instant, ZoneOffset.UTC);
	}
	...
	public static OffsetDateTime tstzspanset_lower(Pointer ss) {
		var result = MeosLibraryPart3.meos.tstzspanset_lower(ss);
		Instant instant = Instant.ofEpochSecond(result);
		return OffsetDateTime.ofInstant(instant, ZoneOffset.UTC);
	}
	...
	public static int tstzspanset_num_timestamps(Pointer ss) {
		return MeosLibraryPart3.meos.tstzspanset_num_timestamps(ss);
	}
	
	@SuppressWarnings("unused")
	public static OffsetDateTime tstzspanset_start_timestamptz(Pointer ss) {
		var result = MeosLibraryPart3.meos.tstzspanset_start_timestamptz(ss);
		Instant instant = Instant.ofEpochSecond(result);
		return OffsetDateTime.ofInstant(instant, ZoneOffset.UTC);
	}
	...
	public static Pointer tstzspanset_timestamptz_n(Pointer ss, int n) {
		...
		Runtime runtime = Runtime.getSystemRuntime();
		Pointer result = Memory.allocateDirect(runtime, Long.BYTES);
		out = MeosLibraryPart3.meos.tstzspanset_timestamptz_n(ss, n, result);
		return out ? result : null ;
	}
	
	@SuppressWarnings("unused")
	public static Pointer tstzspanset_timestamps(Pointer ss) {
		return MeosLibraryPart3.meos.tstzspanset_timestamps(ss);
	}
	
	@SuppressWarnings("unused")
	public static OffsetDateTime tstzspanset_upper(Pointer ss) {
		var result = MeosLibraryPart3.meos.tstzspanset_upper(ss);
		Instant instant = Instant.ofEpochSecond(result);
		return OffsetDateTime.ofInstant(instant, ZoneOffset.UTC);
	}
	...
	public static OffsetDateTime timestamptz_tprecision(OffsetDateTime t, Pointer duration, OffsetDateTime torigin) {
		...
		var result = MeosLibraryPart3.meos.timestamptz_tprecision(t_new, duration, torigin_new);
		Instant instant = Instant.ofEpochSecond(result);
		return OffsetDateTime.ofInstant(instant, ZoneOffset.UTC);
	}
	...
	public static Pointer spanset_union_transfn(Pointer state, Pointer ss) {
		return MeosLibraryPart2.meos.spanset_union_transfn(state, ss);
	}
	
	@SuppressWarnings("unused")
	public static Pointer text_union_transfn(Pointer state, Pointer txt) {
		return MeosLibraryPart3.meos.text_union_transfn(state, txt);
	}
	
	@SuppressWarnings("unused")
	public static Pointer timestamptz_extent_transfn(Pointer state, OffsetDateTime t) {
		var t_new = t.toEpochSecond();
		return MeosLibraryPart3.meos.timestamptz_extent_transfn(state, t_new);
	}
	
	@SuppressWarnings("unused")
	public static Pointer timestamptz_union_transfn(Pointer state, OffsetDateTime t) {
		var t_new = t.toEpochSecond();
		return MeosLibraryPart3.meos.timestamptz_union_transfn(state, t_new);
	}
	
	@SuppressWarnings("unused")
	public static Pointer tbox_in(String str) {
		return MeosLibraryPart2.meos.tbox_in(str);
	}
	
	@SuppressWarnings("unused")
	public static String tbox_out(Pointer box, int maxdd) {
		return MeosLibraryPart2.meos.tbox_out(box, maxdd);
	}
	
	@SuppressWarnings("unused")
	public static Pointer tbox_from_wkb(Pointer wkb, long size) {
		return MeosLibraryPart2.meos.tbox_from_wkb(wkb, size);
	}
	
	@SuppressWarnings("unused")
	public static Pointer tbox_from_hexwkb(String hexwkb) {
		return MeosLibraryPart2.meos.tbox_from_hexwkb(hexwkb);
	}
	
	@SuppressWarnings("unused")
	public static Pointer stbox_from_wkb(Pointer wkb, long size) {
		return MeosLibraryPart2.meos.stbox_from_wkb(wkb, size);
	}
	
	@SuppressWarnings("unused")
	public static Pointer stbox_from_hexwkb(String hexwkb) {
		return MeosLibraryPart2.meos.stbox_from_hexwkb(hexwkb);
	}
	...
	public static String tbox_as_hexwkb(Pointer box, byte variant, Pointer size) {
		return MeosLibraryPart2.meos.tbox_as_hexwkb(box, variant, size);
	}
	...
	public static Pointer stbox_make(boolean hasx, boolean hasz, boolean geodetic, int srid, double xmin, double xmax, double ymin, double ymax, double zmin, double zmax, Pointer s) {
		return MeosLibraryPart2.meos.stbox_make(hasx, hasz, geodetic, srid, xmin, xmax, ymin, ymax, zmin, zmax, s);
	}
	
	@SuppressWarnings("unused")
	public static Pointer tbox_copy(Pointer box) {
		return MeosLibraryPart2.meos.tbox_copy(box);
	}
	
	@SuppressWarnings("unused")
	public static Pointer tbox_make(Pointer s, Pointer p) {
		return MeosLibraryPart2.meos.tbox_make(s, p);
	}
	
	@SuppressWarnings("unused")
	public static Pointer float_to_tbox(double d) {
		return MeosLibraryPart1.meos.float_to_tbox(d);
	}
	
	@SuppressWarnings("unused")
	public static Pointer geo_to_stbox(Pointer gs) {
		return MeosLibraryPart1.meos.geo_to_stbox(gs);
	}
	
	@SuppressWarnings("unused")
	public static Pointer int_to_tbox(int i) {
		return MeosLibraryPart1.meos.int_to_tbox(i);
	}
	
	@SuppressWarnings("unused")
	public static Pointer set_to_tbox(Pointer s) {
		return MeosLibraryPart2.meos.set_to_tbox(s);
	}
	
	@SuppressWarnings("unused")
	public static Pointer span_to_tbox(Pointer s) {
		return MeosLibraryPart2.meos.span_to_tbox(s);
	}
	
	@SuppressWarnings("unused")
	public static Pointer spanset_to_tbox(Pointer ss) {
		return MeosLibraryPart2.meos.spanset_to_tbox(ss);
	}
	
	@SuppressWarnings("unused")
	public static Pointer spatialset_to_stbox(Pointer s) {
		return MeosLibraryPart2.meos.spatialset_to_stbox(s);
	}
	
	@SuppressWarnings("unused")
	public static Pointer stbox_to_gbox(Pointer box) {
		return MeosLibraryPart2.meos.stbox_to_gbox(box);
	}
	
	@SuppressWarnings("unused")
	public static Pointer stbox_to_box3d(Pointer box) {
		return MeosLibraryPart2.meos.stbox_to_box3d(box);
	}
	
	@SuppressWarnings("unused")
	public static Pointer stbox_to_geo(Pointer box) {
		return MeosLibraryPart2.meos.stbox_to_geo(box);
	}
	
	@SuppressWarnings("unused")
	public static Pointer stbox_to_tstzspan(Pointer box) {
		return MeosLibraryPart2.meos.stbox_to_tstzspan(box);
	}
	
	@SuppressWarnings("unused")
	public static Pointer tbox_to_intspan(Pointer box) {
		return MeosLibraryPart2.meos.tbox_to_intspan(box);
	}
	
	@SuppressWarnings("unused")
	public static Pointer tbox_to_floatspan(Pointer box) {
		return MeosLibraryPart2.meos.tbox_to_floatspan(box);
	}
	
	@SuppressWarnings("unused")
	public static Pointer tbox_to_tstzspan(Pointer box) {
		return MeosLibraryPart2.meos.tbox_to_tstzspan(box);
	}
	
	@SuppressWarnings("unused")
	public static Pointer timestamptz_to_stbox(OffsetDateTime t) {
		var t_new = t.toEpochSecond();
		return MeosLibraryPart3.meos.timestamptz_to_stbox(t_new);
	}
	
	@SuppressWarnings("unused")
	public static Pointer timestamptz_to_tbox(OffsetDateTime t) {
		var t_new = t.toEpochSecond();
		return MeosLibraryPart3.meos.timestamptz_to_tbox(t_new);
	}
	
	@SuppressWarnings("unused")
	public static Pointer tstzset_to_stbox(Pointer s) {
		return MeosLibraryPart3.meos.tstzset_to_stbox(s);
	}
	...
	public static Pointer tstzspanset_to_stbox(Pointer ss) {
		return MeosLibraryPart3.meos.tstzspanset_to_stbox(ss);
	}
	
	@SuppressWarnings("unused")
	public static Pointer tnumber_to_tbox(Pointer temp) {
		return MeosLibraryPart3.meos.tnumber_to_tbox(temp);
	}
	
	@SuppressWarnings("unused")
	public static Pointer tpoint_to_stbox(Pointer temp) {
		return MeosLibraryPart3.meos.tpoint_to_stbox(temp);
	}

	@SuppressWarnings("unused")
	public static Pointer tspatial_to_stbox(Pointer temp) {
		return MeosLibraryPart3.meos.tspatial_to_stbox(temp);
	}

	@SuppressWarnings("unused")
	public static boolean stbox_hast(Pointer box) {
		return MeosLibraryPart2.meos.stbox_hast(box);
	}
	
	@SuppressWarnings("unused")
	public static boolean stbox_hasx(Pointer box) {
		return MeosLibraryPart2.meos.stbox_hasx(box);
	}
	
	@SuppressWarnings("unused")
	public static boolean stbox_hasz(Pointer box) {
		return MeosLibraryPart2.meos.stbox_hasz(box);
	}
	
	@SuppressWarnings("unused")
	public static boolean stbox_isgeodetic(Pointer box) {
		return MeosLibraryPart2.meos.stbox_isgeodetic(box);
	}

	@SuppressWarnings("unused")
	public static double stbox_area(Pointer box, boolean spheroid) {
		return MeosLibraryPart2.meos.stbox_area(box, spheroid);
	}

	@SuppressWarnings("unused")
	public static double stbox_perimeter(Pointer box, boolean spheroid) {
		return MeosLibraryPart2.meos.stbox_perimeter(box, spheroid);
	}

	@SuppressWarnings("unused")
	public static double stbox_volume(Pointer box) {
		return MeosLibraryPart2.meos.stbox_volume(box);
	}

	@SuppressWarnings("unused")
	public static int stbox_srid(Pointer box) {
		return MeosLibraryPart2.meos.stbox_srid(box);
	}
	...
	public static Pointer stbox_tmax(Pointer box) {
		...
		Runtime runtime = Runtime.getSystemRuntime();
		Pointer result = Memory.allocateDirect(runtime, Long.BYTES);
		out = MeosLibraryPart2.meos.stbox_tmax(box, result);
		return out ? result : null ;
	}
	...
	public static Pointer stbox_tmax_inc(Pointer box) {
		...
		Runtime runtime = Runtime.getSystemRuntime();
		Pointer result = Memory.allocateDirect(runtime, Long.BYTES);
		out = MeosLibraryPart2.meos.stbox_tmax_inc(box, result);
		return out ? result : null ;
	}
	...
	public static Pointer stbox_tmin(Pointer box) {
		...
		Runtime runtime = Runtime.getSystemRuntime();
		Pointer result = Memory.allocateDirect(runtime, Long.BYTES);
		out = MeosLibraryPart2.meos.stbox_tmin(box, result);
		return out ? result : null ;
	}
	...
	public static Pointer stbox_tmin_inc(Pointer box) {
		...
		Runtime runtime = Runtime.getSystemRuntime();
		Pointer result = Memory.allocateDirect(runtime, Long.BYTES);
		out = MeosLibraryPart2.meos.stbox_tmin_inc(box, result);
		return out ? result : null ;
	}
	...
	public static Pointer stbox_xmax(Pointer box) {
		...
		Runtime runtime = Runtime.getSystemRuntime();
		Pointer result = Memory.allocateDirect(runtime, Long.BYTES);
		out = MeosLibraryPart2.meos.stbox_xmax(box, result);
		return out ? result : null ;
	}
	...
	public static Pointer stbox_xmin(Pointer box) {
		...
		Runtime runtime = Runtime.getSystemRuntime();
		Pointer result = Memory.allocateDirect(runtime, Long.BYTES);
		out = MeosLibraryPart2.meos.stbox_xmin(box, result);
		return out ? result : null ;
	}
	...
	public static Pointer stbox_ymax(Pointer box) {
		...
		Runtime runtime = Runtime.getSystemRuntime();
		Pointer result = Memory.allocateDirect(runtime, Long.BYTES);
		out = MeosLibraryPart2.meos.stbox_ymax(box, result);
		return out ? result : null ;
	}
	...
	public static Pointer stbox_ymin(Pointer box) {
		...
		Runtime runtime = Runtime.getSystemRuntime();
		Pointer result = Memory.allocateDirect(runtime, Long.BYTES);
		out = MeosLibraryPart2.meos.stbox_ymin(box, result);
		return out ? result : null ;
	}
	...
	public static Pointer stbox_zmax(Pointer box) {
		...
		Runtime runtime = Runtime.getSystemRuntime();
		Pointer result = Memory.allocateDirect(runtime, Long.BYTES);
		out = MeosLibraryPart2.meos.stbox_zmax(box, result);
		return out ? result : null ;
	}
	...
	public static Pointer stbox_zmin(Pointer box) {
		...
		Runtime runtime = Runtime.getSystemRuntime();
		Pointer result = Memory.allocateDirect(runtime, Long.BYTES);
		out = MeosLibraryPart2.meos.stbox_zmin(box, result);
		return out ? result : null ;
	}
	
	@SuppressWarnings("unused")
	public static boolean tbox_hast(Pointer box) {
		return MeosLibraryPart2.meos.tbox_hast(box);
	}
	
	@SuppressWarnings("unused")
	public static boolean tbox_hasx(Pointer box) {
		return MeosLibraryPart2.meos.tbox_hasx(box);
	}
	...
	public static Pointer tbox_tmax(Pointer box) {
		...
		Runtime runtime = Runtime.getSystemRuntime();
		Pointer result = Memory.allocateDirect(runtime, Long.BYTES);
		out = MeosLibraryPart2.meos.tbox_tmax(box, result);
		return out ? result : null ;
	}
	...
	public static Pointer tbox_tmax_inc(Pointer box) {
		...
		Runtime runtime = Runtime.getSystemRuntime();
		Pointer result = Memory.allocateDirect(runtime, Long.BYTES);
		out = MeosLibraryPart2.meos.tbox_tmax_inc(box, result);
		return out ? result : null ;
	}
	...
	public static Pointer tbox_tmin(Pointer box) {
		...
		Runtime runtime = Runtime.getSystemRuntime();
		Pointer result = Memory.allocateDirect(runtime, Long.BYTES);
		out = MeosLibraryPart2.meos.tbox_tmin(box, result);
		return out ? result : null ;
	}
	...
	public static Pointer tbox_tmin_inc(Pointer box) {
		...
		Runtime runtime = Runtime.getSystemRuntime();
		Pointer result = Memory.allocateDirect(runtime, Long.BYTES);
		out = MeosLibraryPart2.meos.tbox_tmin_inc(box, result);
		return out ? result : null ;
	}
	...
	public static Pointer tbox_xmax(Pointer box) {
		...
		Runtime runtime = Runtime.getSystemRuntime();
		Pointer result = Memory.allocateDirect(runtime, Long.BYTES);
		out = MeosLibraryPart2.meos.tbox_xmax(box, result);
		return out ? result : null ;
	}
	...
	public static Pointer tbox_xmax_inc(Pointer box) {
		...
		Runtime runtime = Runtime.getSystemRuntime();
		Pointer result = Memory.allocateDirect(runtime, Long.BYTES);
		out = MeosLibraryPart2.meos.tbox_xmax_inc(box, result);
		return out ? result : null ;
	}
	...
	public static Pointer tbox_xmin(Pointer box) {
		...
		Runtime runtime = Runtime.getSystemRuntime();
		Pointer result = Memory.allocateDirect(runtime, Long.BYTES);
		out = MeosLibraryPart2.meos.tbox_xmin(box, result);
		return out ? result : null ;
	}
	...
	public static Pointer tbox_xmin_inc(Pointer box) {
		...
		Runtime runtime = Runtime.getSystemRuntime();
		Pointer result = Memory.allocateDirect(runtime, Long.BYTES);
		out = MeosLibraryPart2.meos.tbox_xmin_inc(box, result);
		return out ? result : null ;
	}
	...
	public static Pointer tboxfloat_xmax(Pointer box) {
		...
		Runtime runtime = Runtime.getSystemRuntime();
		Pointer result = Memory.allocateDirect(runtime, Long.BYTES);
		out = MeosLibraryPart2.meos.tboxfloat_xmax(box, result);
		return out ? result : null ;
	}
	...
	public static Pointer tboxfloat_xmin(Pointer box) {
		...
		Runtime runtime = Runtime.getSystemRuntime();
		Pointer result = Memory.allocateDirect(runtime, Long.BYTES);
		out = MeosLibraryPart2.meos.tboxfloat_xmin(box, result);
		return out ? result : null ;
	}
	...
	public static Pointer tboxint_xmax(Pointer box) {
		...
		Runtime runtime = Runtime.getSystemRuntime();
		Pointer result = Memory.allocateDirect(runtime, Long.BYTES);
		out = MeosLibraryPart2.meos.tboxint_xmax(box, result);
		return out ? result : null ;
	}
	...
	public static Pointer temporal_as_wkb(Pointer temp, byte variant) {
		Runtime runtime = Runtime.getSystemRuntime();
		Pointer size_out = Memory.allocateDirect(runtime, Long.BYTES);
		return MeosLibraryPart2.meos.temporal_as_wkb(temp, variant, size_out);
	}
	...
	public static Pointer tbool_from_base_temp(boolean b, Pointer temp) {
		return MeosLibraryPart2.meos.tbool_from_base_temp(b, temp);
	}
	
	@SuppressWarnings("unused")
	public static Pointer tboolinst_make(boolean b, OffsetDateTime t) {
		var t_new = t.toEpochSecond();
		return MeosLibraryPart2.meos.tboolinst_make(b, t_new);
	}
	
	@SuppressWarnings("unused")
	public static Pointer tboolseq_from_base_tstzset(boolean b, Pointer s) {
		return MeosLibraryPart2.meos.tboolseq_from_base_tstzset(b, s);
	}
	
	@SuppressWarnings("unused")
	public static Pointer tboolseq_from_base_tstzspan(boolean b, Pointer s) {
		return MeosLibraryPart2.meos.tboolseq_from_base_tstzspan(b, s);
	}
	
	@SuppressWarnings("unused")
	public static Pointer tboolseqset_from_base_tstzspanset(boolean b, Pointer ss) {
		return MeosLibraryPart2.meos.tboolseqset_from_base_tstzspanset(b, ss);
	}
	...
	public static Pointer tbool_value_n(Pointer temp, int n) {
		...
		Runtime runtime = Runtime.getSystemRuntime();
		Pointer result = Memory.allocateDirect(runtime, Long.BYTES);
		out = MeosLibraryPart2.meos.tbool_value_n(temp, n, result);
		return out ? result : null ;
	}
	
	@SuppressWarnings("unused")
	public static Pointer tbool_values(Pointer temp, Pointer count) {
		return MeosLibraryPart2.meos.tbool_values(temp, count);
	}
	
	@SuppressWarnings("unused")
	public static Pointer temporal_duration(Pointer temp, boolean boundspan) {
		return MeosLibraryPart2.meos.temporal_duration(temp, boundspan);
	}
	
	@SuppressWarnings("unused")
	public static Pointer temporal_end_instant(Pointer temp) {
		return MeosLibraryPart2.meos.temporal_end_instant(temp);
	}
	
	@SuppressWarnings("unused")
	public static Pointer temporal_end_sequence(Pointer temp) {
		return MeosLibraryPart2.meos.temporal_end_sequence(temp);
	}
	
	@SuppressWarnings("unused")
	public static OffsetDateTime temporal_end_timestamptz(Pointer temp) {
		var result = MeosLibraryPart2.meos.temporal_end_timestamptz(temp);
		Instant instant = Instant.ofEpochSecond(result);
		return OffsetDateTime.ofInstant(instant, ZoneOffset.UTC);
	}
	...
	public static int temporal_hash(Pointer temp) {
		return MeosLibraryPart2.meos.temporal_hash(temp);
	}
	
	@SuppressWarnings("unused")
	public static Pointer temporal_instant_n(Pointer temp, int n) {
		return MeosLibraryPart2.meos.temporal_instant_n(temp, n);
	}
	
	@SuppressWarnings("unused")
	public static Pointer temporal_instants(Pointer temp, Pointer count) {
		return MeosLibraryPart2.meos.temporal_instants(temp, count);
	}
	
	@SuppressWarnings("unused")
	public static String temporal_interp(Pointer temp) {
		return MeosLibraryPart2.meos.temporal_interp(temp);
	}
	
	@SuppressWarnings("unused")
	public static Pointer temporal_max_instant(Pointer temp) {
		return MeosLibraryPart2.meos.temporal_max_instant(temp);
	}
	
	@SuppressWarnings("unused")
	public static Pointer temporal_min_instant(Pointer temp) {
		return MeosLibraryPart2.meos.temporal_min_instant(temp);
	}
	
	@SuppressWarnings("unused")
	public static int temporal_num_instants(Pointer temp) {
		return MeosLibraryPart3.meos.temporal_num_instants(temp);
	}
	
	@SuppressWarnings("unused")
	public static int temporal_num_sequences(Pointer temp) {
		return MeosLibraryPart3.meos.temporal_num_sequences(temp);
	}
	
	@SuppressWarnings("unused")
	public static int temporal_num_timestamps(Pointer temp) {
		return MeosLibraryPart3.meos.temporal_num_timestamps(temp);
	}
	
	@SuppressWarnings("unused")
	public static Pointer temporal_segments(Pointer temp, Pointer count) {
		return MeosLibraryPart3.meos.temporal_segments(temp, count);
	}
	
	@SuppressWarnings("unused")
	public static Pointer temporal_sequence_n(Pointer temp, int i) {
		return MeosLibraryPart3.meos.temporal_sequence_n(temp, i);
	}
	
	@SuppressWarnings("unused")
	public static Pointer temporal_sequences(Pointer temp, Pointer count) {
		return MeosLibraryPart3.meos.temporal_sequences(temp, count);
	}
	
	@SuppressWarnings("unused")
	public static int temporal_lower_inc(Pointer temp) {
		return MeosLibraryPart2.meos.temporal_lower_inc(temp);
	}
	
	@SuppressWarnings("unused")
	public static int temporal_upper_inc(Pointer temp) {
		return MeosLibraryPart3.meos.temporal_upper_inc(temp);
	}
	...
	public static Pointer temporal_start_sequence(Pointer temp) {
		return MeosLibraryPart3.meos.temporal_start_sequence(temp);
	}
	
	@SuppressWarnings("unused")
	public static OffsetDateTime temporal_start_timestamptz(Pointer temp) {
		var result = MeosLibraryPart3.meos.temporal_start_timestamptz(temp);
		Instant instant = Instant.ofEpochSecond(result);
		return OffsetDateTime.ofInstant(instant, ZoneOffset.UTC);
	}
	...
	public static Pointer temporal_stops(Pointer temp, double maxdist, Pointer minduration) {
		return MeosLibraryPart3.meos.temporal_stops(temp, maxdist, minduration);
	}
	
	@SuppressWarnings("unused")
	public static String temporal_subtype(Pointer temp) {
		return MeosLibraryPart3.meos.temporal_subtype(temp);
	}
	
	@SuppressWarnings("unused")
	public static Pointer temporal_time(Pointer temp) {
		return MeosLibraryPart3.meos.temporal_time(temp);
	}
	...
	public static Pointer temporal_timestamptz_n(Pointer temp, int n) {
		...
		Runtime runtime = Runtime.getSystemRuntime();
		Pointer result = Memory.allocateDirect(runtime, Long.BYTES);
		out = MeosLibraryPart3.meos.temporal_timestamptz_n(temp, n, result);
		return out ? result : null ;
	}
	
	@SuppressWarnings("unused")
	public static Pointer temporal_timestamps(Pointer temp, Pointer count) {
		return MeosLibraryPart3.meos.temporal_timestamps(temp, count);
	}
	
	@SuppressWarnings("unused")
	public static double tfloat_end_value(Pointer temp) {
		return MeosLibraryPart3.meos.tfloat_end_value(temp);
	}
	
	@SuppressWarnings("unused")
	public static double tfloat_max_value(Pointer temp) {
		return MeosLibraryPart3.meos.tfloat_max_value(temp);
	}
	
	@SuppressWarnings("unused")
	public static double tfloat_min_value(Pointer temp) {
		return MeosLibraryPart3.meos.tfloat_min_value(temp);
	}
	
	@SuppressWarnings("unused")
	public static double tfloat_start_value(Pointer temp) {
		return MeosLibraryPart3.meos.tfloat_start_value(temp);
	}
	
	@SuppressWarnings("unused")
	public static boolean tfloat_value_at_timestamptz(Pointer temp, OffsetDateTime t, boolean strict, Pointer value) {
		var t_new = t.toEpochSecond();
		return MeosLibraryPart3.meos.tfloat_value_at_timestamptz(temp, t_new, strict, value);
	}
	...
	public static Pointer tfloat_value_n(Pointer temp, int n) {
		...
		Runtime runtime = Runtime.getSystemRuntime();
		Pointer result = Memory.allocateDirect(runtime, Long.BYTES);
		out = MeosLibraryPart3.meos.tfloat_value_n(temp, n, result);
		return out ? result : null ;
	}
	
	@SuppressWarnings("unused")
	public static Pointer tfloat_values(Pointer temp, Pointer count) {
		return MeosLibraryPart3.meos.tfloat_values(temp, count);
	}
	
	@SuppressWarnings("unused")
	public static int tint_end_value(Pointer temp) {
		return MeosLibraryPart3.meos.tint_end_value(temp);
	}
	
	@SuppressWarnings("unused")
	public static int tint_max_value(Pointer temp) {
		return MeosLibraryPart3.meos.tint_max_value(temp);
	}
	
	@SuppressWarnings("unused")
	public static int tint_min_value(Pointer temp) {
		return MeosLibraryPart3.meos.tint_min_value(temp);
	}
	
	@SuppressWarnings("unused")
	public static int tint_start_value(Pointer temp) {
		return MeosLibraryPart3.meos.tint_start_value(temp);
	}
	
	@SuppressWarnings("unused")
	public static boolean tint_value_at_timestamptz(Pointer temp, OffsetDateTime t, boolean strict, Pointer value) {
		var t_new = t.toEpochSecond();
		return MeosLibraryPart3.meos.tint_value_at_timestamptz(temp, t_new, strict, value);
	}
	...
	public static Pointer tint_value_n(Pointer temp, int n) {
		...
		Runtime runtime = Runtime.getSystemRuntime();
		Pointer result = Memory.allocateDirect(runtime, Long.BYTES);
		out = MeosLibraryPart3.meos.tint_value_n(temp, n, result);
		return out ? result : null ;
	}
	
	@SuppressWarnings("unused")
	public static Pointer tint_values(Pointer temp, Pointer count) {
		return MeosLibraryPart3.meos.tint_values(temp, count);
	}
	
	@SuppressWarnings("unused")
	public static double tnumber_integral(Pointer temp) {
		return MeosLibraryPart3.meos.tnumber_integral(temp);
	}
	
	@SuppressWarnings("unused")
	public static double tnumber_twavg(Pointer temp) {
		return MeosLibraryPart3.meos.tnumber_twavg(temp);
	}
	
	@SuppressWarnings("unused")
	public static Pointer tnumber_valuespans(Pointer temp) {
		return MeosLibraryPart3.meos.tnumber_valuespans(temp);
	}
	
	@SuppressWarnings("unused")
	public static Pointer tgeo_end_value(Pointer temp) {
		return MeosLibraryPart3.meos.tgeo_end_value(temp);
	}
	
	@SuppressWarnings("unused")
	public static Pointer tgeo_start_value(Pointer temp) {
		return MeosLibraryPart3.meos.tgeo_start_value(temp);
	}
	
	@SuppressWarnings("unused")
	public static boolean tpoint_value_at_timestamptz(Pointer temp, OffsetDateTime t, boolean strict, Pointer value) {
		var t_new = t.toEpochSecond();
		return MeosLibraryPart3.meos.tpoint_value_at_timestamptz(temp, t_new, strict, value);
	}
	...
	public static Pointer tgeo_value_n(Pointer temp, int n) {
		Runtime runtime = Runtime.getSystemRuntime();
		Pointer result = Memory.allocateDirect(runtime, Long.BYTES);
		boolean out = MeosLibraryPart3.meos.tgeo_value_n(temp, n, result);
	...
	public static Pointer tpoint_value_n(Pointer temp, int n) {
		...
		Runtime runtime = Runtime.getSystemRuntime();
		Pointer result = Memory.allocateDirect(runtime, Long.BYTES);
		out = MeosLibraryPart3.meos.tpoint_value_n(temp, n, result);
		Pointer new_result = result.getPointer(0);
		return out ? new_result : null ;
	}
	...
	public static Pointer tpoint_values(Pointer temp, Pointer count) {
		return MeosLibraryPart3.meos.tpoint_values(temp, count);
	}
	
	@SuppressWarnings("unused")
	public static Pointer ttext_end_value(Pointer temp) {
		return MeosLibraryPart3.meos.ttext_end_value(temp);
	}
	...
	public static Pointer ttext_min_value(Pointer temp) {
		return MeosLibraryPart3.meos.ttext_min_value(temp);
	}
	
	@SuppressWarnings("unused")
	public static Pointer ttext_start_value(Pointer temp) {
		return MeosLibraryPart3.meos.ttext_start_value(temp);
	}
	
	@SuppressWarnings("unused")
	public static boolean ttext_value_at_timestamptz(Pointer temp, OffsetDateTime t, boolean strict, Pointer value) {
		var t_new = t.toEpochSecond();
		return MeosLibraryPart3.meos.ttext_value_at_timestamptz(temp, t_new, strict, value);
	}
	...
	public static Pointer ttext_value_n(Pointer temp, int n) {
		...
		Runtime runtime = Runtime.getSystemRuntime();
		Pointer result = Memory.allocateDirect(runtime, Long.BYTES);
		out = MeosLibraryPart3.meos.ttext_value_n(temp, n, result);
		Pointer new_result = result.getPointer(0);
		return out ? new_result : null ;
	}
	...
	public static Pointer ttext_values(Pointer temp, Pointer count) {
		return MeosLibraryPart3.meos.ttext_values(temp, count);
	}
	
	@SuppressWarnings("unused")
	public static double float_degrees(double value, boolean normalize) {
		return MeosLibraryPart1.meos.float_degrees(value, normalize);
	}
	
	@SuppressWarnings("unused")
	public static Pointer temporal_scale_time(Pointer temp, Pointer duration) {
		return MeosLibraryPart3.meos.temporal_scale_time(temp, duration);
	}
	
	@SuppressWarnings("unused")
	public static Pointer temporal_set_interp(Pointer temp, int interp) {
		return MeosLibraryPart3.meos.temporal_set_interp(temp, interp);
	}
	
	@SuppressWarnings("unused")
	public static Pointer temporal_shift_scale_time(Pointer temp, Pointer shift, Pointer duration) {
		return MeosLibraryPart3.meos.temporal_shift_scale_time(temp, shift, duration);
	}
	...
	public static Pointer tfloatarr_round(Pointer temp, int count, int maxdd) {
		return MeosLibraryPart3.meos.tfloatarr_round(temp, count, maxdd);
	}
	
	@SuppressWarnings("unused")
	public static Pointer tint_scale_value(Pointer temp, int width) {
		return MeosLibraryPart3.meos.tint_scale_value(temp, width);
	}
	
	@SuppressWarnings("unused")
	public static Pointer tint_shift_scale_value(Pointer temp, int shift, int width) {
		return MeosLibraryPart3.meos.tint_shift_scale_value(temp, shift, width);
	}
	...
	public static Pointer bearing_point_point(Pointer gs1, Pointer gs2) {
		...
		Runtime runtime = Runtime.getSystemRuntime();
		Pointer result = Memory.allocateDirect(runtime, Long.BYTES);
		out = MeosLibraryPart0.meos.bearing_point_point(gs1, gs2, result);
		return out ? result : null ;
	}
	
	@SuppressWarnings("unused")
	public static Pointer bearing_tpoint_point(Pointer temp, Pointer gs, boolean invert) {
		return MeosLibraryPart0.meos.bearing_tpoint_point(temp, gs, invert);
	}
	
	@SuppressWarnings("unused")
	public static Pointer bearing_tpoint_tpoint(Pointer temp1, Pointer temp2) {
		return MeosLibraryPart0.meos.bearing_tpoint_tpoint(temp1, temp2);
	}
	
	@SuppressWarnings("unused")
	public static Pointer tpoint_angular_difference(Pointer temp) {
		return MeosLibraryPart3.meos.tpoint_angular_difference(temp);
	}
	
	@SuppressWarnings("unused")
	public static Pointer tpoint_azimuth(Pointer temp) {
		return MeosLibraryPart3.meos.tpoint_azimuth(temp);
	}
	...
	public static Pointer tpoint_convex_hull(Pointer temp) {
		return MeosLibraryPart3.meos.tpoint_convex_hull(temp);
	}
	
	@SuppressWarnings("unused")
	public static Pointer tgeo_traversed_area(Pointer temp, boolean unary_union) {
		return MeosLibraryPart3.meos.tgeo_traversed_area(temp, unary_union);
	}

	@SuppressWarnings("unused")
	public static Pointer tpoint_cumulative_length(Pointer temp) {
		return MeosLibraryPart3.meos.tpoint_cumulative_length(temp);
	}
	...
	public static Pointer tpoint_direction(Pointer temp) {
		...
		Runtime runtime = Runtime.getSystemRuntime();
		Pointer result = Memory.allocateDirect(runtime, Long.BYTES);
		out = MeosLibraryPart3.meos.tpoint_direction(temp, result);
		return out ? result : null ;
	}
	
	@SuppressWarnings("unused")
	public static Pointer tpoint_get_x(Pointer temp) {
		return MeosLibraryPart3.meos.tpoint_get_x(temp);
	}
	
	@SuppressWarnings("unused")
	public static Pointer tpoint_get_y(Pointer temp) {
		return MeosLibraryPart3.meos.tpoint_get_y(temp);
	}
	
	@SuppressWarnings("unused")
	public static Pointer tpoint_get_z(Pointer temp) {
		return MeosLibraryPart3.meos.tpoint_get_z(temp);
	}
	
	@SuppressWarnings("unused")
	public static boolean tpoint_is_simple(Pointer temp) {
		return MeosLibraryPart3.meos.tpoint_is_simple(temp);
	}
	
	@SuppressWarnings("unused")
	public static double tpoint_length(Pointer temp) {
		return MeosLibraryPart3.meos.tpoint_length(temp);
	}
	
	@SuppressWarnings("unused")
	public static Pointer tpoint_speed(Pointer temp) {
		return MeosLibraryPart3.meos.tpoint_speed(temp);
	}
	
	@SuppressWarnings("unused")
	public static int tspatial_srid(Pointer temp) {
		return MeosLibraryPart3.meos.tspatial_srid(temp);
	}

	@SuppressWarnings("unused")
	public static int tpoint_srid(Pointer temp) {
		return MeosLibraryPart3.meos.tpoint_srid(temp);
	}
	
	@SuppressWarnings("unused")
	public static Pointer tpoint_stboxes(Pointer temp, Pointer count) {
		return MeosLibraryPart3.meos.tpoint_stboxes(temp, count);
	}
	
	@SuppressWarnings("unused")
	public static Pointer tpoint_trajectory(Pointer temp, boolean unary_union) {
		return MeosLibraryPart3.meos.tpoint_trajectory(temp, unary_union);
	}
	
	@SuppressWarnings("unused")
	public static Pointer tpoint_twcentroid(Pointer temp) {
		return MeosLibraryPart3.meos.tpoint_twcentroid(temp);
	}
	
	@SuppressWarnings("unused")
	public static Pointer geo_expand_space(Pointer gs, double d) {
		return MeosLibraryPart1.meos.geo_expand_space(gs, d);
	}
	
	@SuppressWarnings("unused")
	public static Pointer geomeas_to_tpoint(Pointer gs) {
		return MeosLibraryPart1.meos.geomeas_to_tpoint(gs);
	}
	
	@SuppressWarnings("unused")
	public static Pointer tgeogpoint_to_tgeompoint(Pointer temp) {
		return MeosLibraryPart3.meos.tgeogpoint_to_tgeompoint(temp);
	}
	
	@SuppressWarnings("unused")
	public static Pointer tgeompoint_to_tgeogpoint(Pointer temp) {
		return MeosLibraryPart3.meos.tgeompoint_to_tgeogpoint(temp);
	}
	...
	public static boolean tpoint_AsMVTGeom(Pointer temp, Pointer bounds, int extent, int buffer, boolean clip_geom, Pointer gsarr, Pointer timesarr, Pointer count) {
		return MeosLibraryPart3.meos.tpoint_AsMVTGeom(temp, bounds, extent, buffer, clip_geom, gsarr, timesarr, count);
	}
	
	@SuppressWarnings("unused")
	public static Pointer tpoint_expand_space(Pointer temp, double d) {
		return MeosLibraryPart3.meos.tpoint_expand_space(temp, d);
	}
	
	@SuppressWarnings("unused")
	public static Pointer tpoint_make_simple(Pointer temp, Pointer count) {
		return MeosLibraryPart3.meos.tpoint_make_simple(temp, count);
	}
	
	@SuppressWarnings("unused")
	public static Pointer tpoint_set_srid(Pointer temp, int srid) {
		return MeosLibraryPart3.meos.tpoint_set_srid(temp, srid);
	}
	...
	public static Pointer tpoint_tfloat_to_geomeas(Pointer tpoint, Pointer measure, boolean segmentize) {
		...
		Runtime runtime = Runtime.getSystemRuntime();
		Pointer result = Memory.allocateDirect(runtime, Long.BYTES);
		out = MeosLibraryPart3.meos.tpoint_tfloat_to_geomeas(tpoint, measure, segmentize, result);
		Pointer new_result = result.getPointer(0);
		return out ? new_result : null ;
	}
	...
	public static Pointer stbox_tile(Pointer point, OffsetDateTime t, double xsize, double ysize, double zsize, Pointer duration, Pointer sorigin, OffsetDateTime torigin, boolean hast) {
		var t_new = t.toEpochSecond();
		var torigin_new = torigin.toEpochSecond();
		return MeosLibraryPart2.meos.stbox_tile(point, t_new, xsize, ysize, zsize, duration, sorigin, torigin_new, hast);
	}
	...
	public static Pointer stbox_tile_list(Pointer bounds, double xsize, double ysize, double zsize, Pointer duration, Pointer sorigin, OffsetDateTime torigin, boolean border_inc, Pointer count) {
		var torigin_new = torigin.toEpochSecond();
		return MeosLibraryPart2.meos.stbox_tile_list(bounds, xsize, ysize, zsize, duration, sorigin, torigin_new, border_inc, count);
	}
	...
	public static Pointer temporal_time_split(Pointer temp, Pointer duration, OffsetDateTime torigin, Pointer time_buckets, Pointer count) {
		var torigin_new = torigin.toEpochSecond();
		return MeosLibraryPart3.meos.temporal_time_split(temp, duration, torigin_new, time_buckets, count);
	}
	
	@SuppressWarnings("unused")
	public static Pointer tfloat_value_split(Pointer temp, double size, double origin, Pointer value_buckets, Pointer count) {
		return MeosLibraryPart3.meos.tfloat_value_split(temp, size, origin, value_buckets, count);
	}
	...
	public static Pointer tfloat_value_time_split(Pointer temp, double size, Pointer duration, double vorigin, OffsetDateTime torigin, Pointer value_buckets, Pointer time_buckets, Pointer count) {
		var torigin_new = torigin.toEpochSecond();
		return MeosLibraryPart3.meos.tfloat_value_time_split(temp, size, duration, vorigin, torigin_new, value_buckets, time_buckets, count);
	}
	...
	public static Pointer tfloatbox_tile(double value, OffsetDateTime t, double vsize, Pointer duration, double vorigin, OffsetDateTime torigin) {
		var t_new = t.toEpochSecond();
		var torigin_new = torigin.toEpochSecond();
		return MeosLibraryPart3.meos.tfloatbox_tile(value, t_new, vsize, duration, vorigin, torigin_new);
	}
	...
	public static Pointer tfloatbox_tile_list(Pointer box, double xsize, Pointer duration, double xorigin, OffsetDateTime torigin, Pointer count) {
		var torigin_new = torigin.toEpochSecond();
		return MeosLibraryPart3.meos.tfloatbox_tile_list(box, xsize, duration, xorigin, torigin_new, count);
	}
	...
	public static OffsetDateTime timestamptz_bucket(OffsetDateTime timestamp, Pointer duration, OffsetDateTime origin) {
		...
		var origin_new = origin.toEpochSecond();
		var result = MeosLibraryPart3.meos.timestamptz_bucket(timestamp_new, duration, origin_new);
		Instant instant = Instant.ofEpochSecond(result);
		return OffsetDateTime.ofInstant(instant, ZoneOffset.UTC);
	}
	...
	public static Pointer tint_value_split(Pointer temp, int size, int origin, Pointer value_buckets, Pointer count) {
		return MeosLibraryPart3.meos.tint_value_split(temp, size, origin, value_buckets, count);
	}
	...
	public static Pointer tint_value_time_split(Pointer temp, int size, Pointer duration, int vorigin, OffsetDateTime torigin, Pointer value_buckets, Pointer time_buckets, Pointer count) {
		var torigin_new = torigin.toEpochSecond();
		return MeosLibraryPart3.meos.tint_value_time_split(temp, size, duration, vorigin, torigin_new, value_buckets, time_buckets, count);
	}
	...
	public static Pointer tintbox_tile(int value, OffsetDateTime t, int vsize, Pointer duration, int vorigin, OffsetDateTime torigin) {
		var t_new = t.toEpochSecond();
		var torigin_new = torigin.toEpochSecond();
		return MeosLibraryPart3.meos.tintbox_tile(value, t_new, vsize, duration, vorigin, torigin_new);
	}
	...
	public static Pointer tintbox_tile_list(Pointer box, int xsize, Pointer duration, int xorigin, OffsetDateTime torigin, Pointer count) {
		var torigin_new = torigin.toEpochSecond();
		return MeosLibraryPart3.meos.tintbox_tile_list(box, xsize, duration, xorigin, torigin_new, count);
	}
	...
	public static Pointer tpoint_space_split(Pointer temp, float xsize, float ysize, float zsize, Pointer sorigin, boolean bitmatrix, boolean border_inc, Pointer space_buckets, Pointer count) {
		return MeosLibraryPart3.meos.tpoint_space_split(temp, xsize, ysize, zsize, sorigin, bitmatrix, border_inc, space_buckets, count);
	}
	...
	public static Pointer tpoint_space_time_split(Pointer temp, float xsize, float ysize, float zsize, Pointer duration, Pointer sorigin, OffsetDateTime torigin, boolean bitmatrix, boolean border_inc, Pointer space_buckets, Pointer time_buckets, Pointer count) {
		var torigin_new = torigin.toEpochSecond();
		return MeosLibraryPart3.meos.tpoint_space_time_split(temp, xsize, ysize, zsize, duration, sorigin, torigin_new, bitmatrix, border_inc, space_buckets, time_buckets, count);
	}
	
	@SuppressWarnings("unused")
	public static Pointer tstzspan_bucket_list(Pointer bounds, Pointer duration, OffsetDateTime origin, Pointer count) {
		var origin_new = origin.toEpochSecond();
		return MeosLibraryPart3.meos.tstzspan_bucket_list(bounds, duration, origin_new, count);
	}
}