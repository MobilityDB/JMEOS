...
public class functions_old {
    public interface MeosLibrary {
        functions_old.MeosLibrary INSTANCE = LibraryLoader.create(functions_old.MeosLibrary.class).load("meos");
        functions_old.MeosLibrary meos = functions_old.MeosLibrary.INSTANCE;
