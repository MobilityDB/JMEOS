...
*/
     ...
     */
    public Temporal at(Object other){
        Pointer result = null;
        if(other instanceof LocalDateTime){
            result= functions.temporal_at_timestamptz(this.inner, ConversionUtils.datetimeToTimestampTz((LocalDateTime) other));
        }
        else if (other instanceof tstzset){
     ...
     */
    public Temporal minus(Object other){
        Pointer result = null;
        if (other instanceof LocalDateTime){
            result= functions.temporal_minus_timestamptz(this.inner, ConversionUtils.datetimeToTimestampTz((LocalDateTime)other));
        }
        else if (other instanceof tstzset){
    ...
    public boolean is_temporally_adjacent(TemporalObject other) throws Exception {
        return this.tstzspan().is_adjacent(other);
    }
    ...
    public boolean is_temporally_contained_in(TemporalObject other) throws Exception {
        return this.tstzspan().is_contained_in(other);
    }
    ...
    public boolean temporally_contains(TemporalObject other) throws Exception {
        return this.tstzspan().contains(other);
    }
    ...
    public boolean temporally_overlaps(TemporalObject other) throws Exception {
        return this.tstzspan().overlaps(other);
    }
    ...
    public boolean is_before(TemporalObject other) throws Exception {
        return this.tstzspan().is_before((Time)other);
    }
    ...
    public boolean is_over_or_before(TemporalObject other) throws Exception {
        return this.tstzspan().is_over_or_before((Time)other);
    }
    ...
    public boolean is_after(TemporalObject other) throws Exception {
        return this.tstzspan().is_after((Time)other);
    }
