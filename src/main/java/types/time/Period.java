...
public class Period extends DataType {
    ...
    public PeriodSet to_periodset(){
        return new PeriodSet(functions.period_to_periodset(this._inner));
    }
    ...
    public boolean is_adjacent_Periodset(PeriodSet other){
        return functions.adjacent_period_periodset(this._inner,other.get_inner());
    }
    ...
    public boolean is_contained_in_Periodset(PeriodSet other){
        return functions.contained_period_periodset(this._inner,other.get_inner());
    }
    ...
    public boolean contains_Periodset(PeriodSet other){
        return functions.contains_period_periodset(this._inner,other.get_inner());
    }
    ...
    public boolean overlaps_Periodset(PeriodSet other){
        return functions.overlaps_period_periodset(this._inner,other.get_inner());
    }
    ...
    public boolean isafter_Periodset(PeriodSet other){
        return functions.after_period_periodset(this._inner,other.get_inner());
    }
