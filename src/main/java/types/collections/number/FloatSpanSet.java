...
public class FloatSpanSet extends SpanSet<Float> implements Number{
    ...
    public FloatSpanSet shift_scale(int delta, int width){
        return new FloatSpanSet(functions.floatspanset_shift_scale(this._inner,delta,width));
    }
    ...
    public boolean is_adjacent(Object other) throws Exception {
        if (other instanceof Integer){
            //return functions.adjacent_floatspanset_float(this._inner, (float) other);
        }
        else{
    ...
    public boolean is_left(Object other) throws Exception {
        if (other instanceof Integer){
            //return functions.left_floatspanset_float(this._inner,(float) other);
        }
        else{
    ...
    public boolean is_over_or_left(Object other) throws Exception {
        if (other instanceof Integer){
            //return functions.overleft_floatspanset_float(this._inner,(float) other);
        }
        else{
    ...
    public boolean is_right(Object other) throws Exception {
        if (other instanceof Integer){
            //return functions.right_floatspanset_float(this._inner,(float) other);
        }
        else{
    ...
    public boolean is_over_or_right(Object other) throws Exception {
        if (other instanceof Integer){
            //return functions.overright_floatspanset_float(this._inner,(float) other);
        }
        else{
    ...
    public float distance(Object other) throws Exception {
        if (other instanceof Integer){
            //return functions.distance_floatspanset_float(this._inner,(float) other);
        }
        else{
