...
public interface TGeomPoint extends TPoint {
	 ...
	 */
	public default TGeomPoint from_base_temporal(Geometry value, Temporal base){
	 ...
	 */
	public default TGeomPoint from_base_time(Geometry value, Time base, TInterpolation interp){
	 ...
	 * @return A new {@link TGeogPoint} object.
	 */
	public default TGeogPoint to_geographic(){
