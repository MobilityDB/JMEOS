...
public class TIntTest {
    ...
    private static Stream<Arguments> frombasetime() {
        ...
        return Stream.of(
                ...
                Arguments.of(new tstzspanset("{[2019-09-01, 2019-09-02],[2019-09-03, 2019-09-05]}"), "TIntSeqSet", TInterpolation.STEPWISE)
        );
    }
    ...
    private static Stream<Arguments> time() throws SQLException {
        ...
        return Stream.of(
                ...
                Arguments.of(new TIntSeqSet("{[1@2019-09-01, 2@2019-09-02],[1@2019-09-03, 1@2019-09-05]}"), "TIntSeqSet", new tstzspanset("{[2019-09-01, 2019-09-02], [2019-09-03, 2019-09-05]}"))
        );
    }
    ...
    private static Stream<Arguments> period() throws SQLException {
        ...
        return Stream.of(
                ...
                Arguments.of(new TIntSeqSet("{[1@2019-09-01, 2@2019-09-02],[1@2019-09-03, 1@2019-09-05]}"), "TIntSeqSet", new tstzspan("[2019-09-01, 2019-09-05]"))
        );
    }
...
//                Arguments.of(new TIntSeqSet("{[1@2019-09-01, 2@2019-09-02]}"), "TIntSeqSet", TInterpolation.DISCRETE, new TIntSeqSet("{[1@2019-09-01, 2@2019-09-02]}"))
    ...
    void testFromBaseTimeConstructor(Time source, String type, TInterpolation interpolation) throws InvocationTargetException, NoSuchMethodException, InstantiationException, IllegalAccessException {
        ...
        if (type == "TIntSeq") {
            ...
            System.out.println(ti.to_string());
